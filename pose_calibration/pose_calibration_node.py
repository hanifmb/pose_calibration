...
class MyNode(Node):
  ...
  def pc_cb(self, msg):
    ...
    transform_msg.child_frame_id = 'calibration_box'
    transform_msg.transform.translation.x = origin[0]
    transform_msg.transform.translation.y = origin[1]
    transform_msg.transform.translation.z = origin[2]
